...
echo "class Arisen < Formula
   ...
   homepage \"${URL}\"
   revision 0
   url \"https://github.com/arisenio/arisenioio/arisen/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/arisenio/arisenioio/arisen/releases/download/v${VERSION}\"
