...
if(CPACK_GENERATOR MATCHES "NSIS")
  ...
  set(CPACK_NSIS_MUI_ICON "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release\\CMakeLogo.ico")
  set(CPACK_NSIS_MUI_UNIICON "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release\\CMakeLogo.ico")
  # set the package header icon for MUI
  set(CPACK_PACKAGE_ICON "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release\\CMakeInstall.bmp")
...
include("/root/arisenx/arisen/1.0/src/cmake-3.13.2/Source/QtDialog/QtDialogCPack.cmake" OPTIONAL)
...
if(CPACK_GENERATOR MATCHES "IFW")
  ...
  set(CPACK_IFW_PACKAGE_WINDOW_ICON
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Source/QtDialog/CMakeSetup128.png")
  set(CPACK_IFW_PACKAGE_CONTROL_SCRIPT
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Source/QtIFW/controlscript.qs")
  ...
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_SCRIPT_TEMPLATE
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Source/QtIFW/installscript.qs.in")
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_SCRIPT_GENERATED
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/CMake.qs")
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_LICENSES
    "CMake Copyright;/root/arisenx/arisen/1.0/src/cmake-3.13.2/Copyright.txt")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-GUI_SCRIPT
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/CMake.Dialogs.QtGUI.qs")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-HTML_SCRIPT
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/CMake.Documentation.SphinxHTML.qs")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-DEVELOPER-REFERENCE-HTML_SCRIPT
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/CMake.DeveloperReference.HTML.qs")
...
if("${CPACK_GENERATOR}" STREQUAL "DragNDrop")
  set(CPACK_DMG_BACKGROUND_IMAGE
      "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Packaging/CMakeDMGBackground.tif")
  set(CPACK_DMG_DS_STORE_SETUP_SCRIPT
      "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Packaging/CMakeDMGSetup.scpt")
endif()
...
if("${CPACK_GENERATOR}" STREQUAL "WIX")
  ...
  set(CPACK_WIX_PRODUCT_ICON
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release/CMakeLogo.ico"
  )
  ...
  set(CPACK_WIX_UI_BANNER
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release/WiX/ui_banner.jpg"
  )

  set(CPACK_WIX_UI_DIALOG
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release/WiX/ui_dialog.jpg"
  )

  set(CPACK_WIX_EXTRA_SOURCES
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release/WiX/install_dir.wxs"
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release/WiX/cmake_extra_dialog.wxs"
  )

  set(_WIX_CUSTOM_ACTION_ENABLED "FALSE")
  if(_WIX_CUSTOM_ACTION_ENABLED)
    list(APPEND CPACK_WIX_EXTRA_SOURCES
      "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release/WiX/cmake_nsis_overwrite_dialog.wxs"
      )
    ...
    if(_WIX_CUSTOM_ACTION_MULTI_CONFIG)
      ...
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release/WiX/custom_action_dll-${_WIX_CUSTOM_ACTION_CONFIG}.wxs")
    else()
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release/WiX/custom_action_dll.wxs")
    endif()
  endif()
  ...
  set(CPACK_WIX_PATCH_FILE
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release/WiX/patch_path_env.xml"
  )

  set(CPACK_WIX_TEMPLATE
    "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release/WiX/WIX.template.in"
  )
  ...
  if(BUILD_QtDialog)
    list(APPEND CPACK_WIX_PATCH_FILE
      "/root/arisenx/arisen/1.0/src/cmake-3.13.2/Utilities/Release/WiX/patch_desktop_shortcut.xml"
      )
