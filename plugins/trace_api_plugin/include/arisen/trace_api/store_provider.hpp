...
#include <arisen/trace_api/common.hpp>
#include <arisen/trace_api/metadata_log.hpp>
#include <arisen/trace_api/data_log.hpp>
...
FC_REFLECT(arisen::trace_api::slice_directory::index_header, (version))
