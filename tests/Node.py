...
class Node(object):
    ...
    def __init__(self, host, port, pid=None, cmd=None, walletMgr=None, enableMongo=False, mongoHost="localhost", mongoPort=27017, mongoDb="RSNtest"):
        self.host=host
        self.port=port
        self.pid=pid
        self.cmd=cmd
    ...
    def rsnClientArgs(self):
        ...
        return self.endpointArgs + walletArgs + " " + Utils.MiscRsnClientArgs
    ...
    def getRsnAccount(self, name, exitOnError=False, returnType=ReturnType.json, avoidMongo=False):
        ...
        if not self.enableMongo or avoidMongo:
            ...
            return self.processArisecliCmd(cmd, cmdDesc, silentErrors=False, exitOnError=exitOnError, exitMsg=msg, returnType=returnType)
        else:
    ...
    # If aosPath is equal to None, it will use the existing aos path
    def relaunch(self, nodeId, chainArg=None, newChain=False, timeout=Utils.systemWaitTimeout, addSwapFlags=None, cachePopen=False, aosPath=None):
        ...
        if aosPath: splittedCmd[0] = aosPath
    ...
    def getLatestBlockHeaderState(self):
        ...
        latestBlockHeaderState = self.processArisecliCmd(cmdDesc, cmdDesc)
