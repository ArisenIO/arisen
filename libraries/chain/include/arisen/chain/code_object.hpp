...
CHAINBASE_SET_INDEX_TYPE(arisen::chain::code_object, arisen::chain::code_index)

FC_REFLECT(arisen::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
