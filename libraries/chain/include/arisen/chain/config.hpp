...
const static name system_account_name    { N(arisen) };
const static name null_account_name      { N(arisen.null) };
const static name producers_account_name { N(arisen.prods) };
...
const static name arisen_auth_scope       { N(arisen.auth) };
const static name arisen_all_scope        { N(arisen.all) };

const static name active_name     { N(active) };
const static name owner_name      { N(owner) };
const static name arisen_any_name  { N(arisen.any) };
const static name arisen_code_name { N(arisen.code) };
...
const static arisen::chain::wasm_interface::vm_type default_wasm_runtime = arisen::chain::wasm_interface::vm_type::wabt;
