...
FC_REFLECT( arisen::chain::detail::block_header_state_common,
            (block_num)
...
FC_REFLECT( arisen::chain::detail::schedule_info,
            (schedule_lib_num)
            (schedule_hash)
            (schedule)
)

FC_REFLECT_DERIVED(  arisen::chain::block_header_state, (arisen::chain::detail::block_header_state_common),
                     (id)
                     (header)
                     (pending_schedule)
...
FC_REFLECT( arisen::chain::legacy::snapshot_block_header_state_v2::schedule_info,
          ( schedule_lib_num )
          ( schedule_hash )
          ( schedule )
)
...
FC_REFLECT( arisen::chain::legacy::snapshot_block_header_state_v2,
          ( block_num )
          ( dpos_proposed_irreversible_blocknum )
          ( dpos_irreversible_blocknum )
          ( active_schedule )
