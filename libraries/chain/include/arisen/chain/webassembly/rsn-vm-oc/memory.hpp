...
#include <arisen/chain/webassembly/eos-vm-oc/gs_seg_helpers.h>
...
#define OFFSET_OF_CONTROL_BLOCK_MEMBER(M) (-(int)arisen::chain::eosvmoc::memory::cb_offset + (int)offsetof(arisen::chain::eosvmoc::control_block, M))
#define OFFSET_OF_FIRST_INTRINSIC ((int)-arisen::chain::eosvmoc::memory::first_intrinsic_offset)