...
std::istream& operator>>(std::istream& in, wasm_interface::vm_type& runtime) {
   ...
   if (s == "wabt")
      ...
      runtime = arisen::chain::wasm_interface::vm_type::eos_vm;
   else if (s == "eos-vm-jit")
      runtime = arisen::chain::wasm_interface::vm_type::eos_vm_jit;
   else if (s == "eos-vm-oc")
      runtime = arisen::chain::wasm_interface::vm_type::eos_vm_oc;
   else
