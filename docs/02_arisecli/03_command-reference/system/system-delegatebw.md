...
- `stake_net_quantity` _TEXT_ - The amount of RSN to delegate for network bandwidth
- `stake_cpu_quantity` _TEXT_  - The amount of RSN to delegate for CPU bandwidth
