...
## Command
A set of ARISEN keys is required to create an account. The ARISEN keys can be generated by using `arisecli create key`.

```sh
arisecli create account inita tester RSN4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq RSN7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
```
