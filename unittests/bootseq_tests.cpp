...
BOOST_FIXTURE_TEST_CASE( bootseq_test, bootseq_tester ) {
    try {
        ...
        // Create RIX tokens in arisen.token, set its manager as arisen
        ...
        // Issue the genesis supply of 1 billion RIX tokens to arisen.system
        ...
        BOOST_TEST(active_schedule.producers.front().producer_name == name("arisen"));
